...
export const defaultPermissionConfig: PermissionConfig = {
  rules: [
    ...
    { tool: "stat_file", decision: "allow" },
    { tool: "git_status", decision: "allow" },
    { tool: "git_diff", decision: "allow" },
    { tool: "git_log", decision: "allow" },
    { tool: "write_file", decision: "ask" },
    { tool: "edit_file", decision: "ask" },
    { tool: "apply_patch", decision: "ask" },
    { tool: "bash", decision: "ask" },
    { tool: "mkdir", decision: "ask" },
    { tool: "move_file", decision: "ask" },
    { tool: "delete_file", decision: "ask" },
    { tool: "invoke_subagent", decision: "ask" },
    { tool: "send_message", decision: "ask" },
  ],
