# phase-10-model-configuration-live-smoke Specification

## Purpose
Define the provider/model configuration contract for model profiles, key-file auth, adapter model-config serialization, and opt-in live provider smoke verification.
